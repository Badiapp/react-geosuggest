    ...
    this.geocoder.geocode(
      ...
      (results, status) => {
        if (status === this.googleMaps.GeocoderStatus.OK) {
          ...
          suggest.matchedSubstrings = gmaps.matched_substrings && gmaps.matched_substrings.length
            ? gmaps.matched_substrings[0]
            : null;
          suggest.type = gmaps.types && gmaps.types.length
            ? gmaps.types[0]
            : null;
        }
        this.props.onSuggestSelect(suggest);
